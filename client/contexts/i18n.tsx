...
const dictionaries: Partial<Record<Locale, Dict>> = {
  ...
  ta: {
    ...
    gunthas: "குன்தா",
    hectares: "ஹெக்டேயர்",
    location: "விவசாயியின் இருப்��ிடம்",
  ...
  te: {
    ...
    irrigationTips: "కీలక దశల్లో ��ీరుపారుదల",
  ...
  kn: {
    ...
    irrigationTips: "ಮುಖ್ಯ ಹಂತಗಳಲ್ಲಿ ನೀರಾವರಿ",
  ...
  ml: {
    ...
    fertilizerTips: "മണ്ണ് പരിശോ���നയെ അടിസ്ഥാനമാക്കി സമതുലിത വളങ്ങൾ",
