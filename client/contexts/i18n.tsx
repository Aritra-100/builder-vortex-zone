...
const dictionaries: Partial<Record<Locale, Dict>> = {
  ...
  ta: {
    ...
    rotationTips: "மண்ணை வளப்படுத்த பயிர் மாற்றம்",
    share: "பகிர்",
    reset: "மீட்டமை",
  ...
  te: {
    ...
    orEnterManually: "లేదా చేతి���ో నమోదు చేయండి",
  ...
  gu: {
    ...enBase,
    tagline: "દરેક ખેડૂત મા��ે સ્માર્ટ ઉપજ અંદાજ",
    heroCta: "ઉપજ ગણો",
  ...
  kn: {
    ...enBase,
    tagline: "ಪ��ರತಿ ರೈತನಿಗೂ ಸ್ಮಾರ್ಟ್ ಬೆಳೆ ಉತ್ಪಾದನೆ ಅಂದಾಜು",
  ...
  ml: {
    ...
    locationPlaceholder: "ഗ്രാം, പട്ടണം അല്ലെങ്കിൽ ജില്ല",
