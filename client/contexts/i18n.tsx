...
const dictionaries: Partial<Record<Locale, Dict>> = {
  ...
  hi: {
    ...
    locationPlaceholder: "गांव, शहर या ��िला",
  ...
  te: {
    ...
    share: "షేర్",
    reset: "రీసెట్",
    gpsDenied: "లోకేషన్ అనుమతి నిర��కరించారు. చేతితో నమోదు చేయండి.",
  },
  mr: {
    ...enBase,
  ...
  ml: {
    ...
    rotationTips: "മണ്ണ് സമ്പുഷ്ടമാക്കാൻ വി���വറിപ്പ്",
    share: "പങ്കിടുക",
    reset: "റീസെറ്റ്",
